...
/**
 * Test script to verify Energy website image optimization is working correctly
 */

function testImageOptimization() {
    console.log('🧪 Testing Energy Website Image Optimization');
    console.log('============================================');
    ...
    const testFiles = [
        'Oil_Pipeline.avif',
        'Oil_Pipeline.webp',
        'rosehill_energy_logo.avif',
        'rosehill_energy_logo.webp',
        'liquid-applied-solutions.avif',
        'liquid-applied-solutions.webp',
        'rosehill_onpipe.avif',
        'rosehill_onpipe.webp',
        'Rosehill_Polymers_BeechRd.avif',
        'Rosehill_Polymers_BeechRd.webp',
        'energy_storage.avif',
        'energy_storage.webp'
    ];
