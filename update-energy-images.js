...
/**
 * Update Energy website HTML files to use AVIF → WebP → JPEG fallback strategy
 * 
 * This script processes all HTML files in the Energy website and converts
 ...
 */
function main() {
    console.log('🚀 Energy Website Image Optimization');
    console.log('===================================');
